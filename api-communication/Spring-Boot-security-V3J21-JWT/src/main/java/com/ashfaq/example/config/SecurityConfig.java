...
//			or a new requestmathcers can be added as below
			...
			requests.requestMatchers(HttpMethod.GET, "/api/items/**").hasAnyRole("USER", "ADMIN"); // Allow GET for both
			requests.requestMatchers(HttpMethod.POST, "/api/items/**").hasRole("ADMIN"); // Only ADMIN can create
			requests.requestMatchers(HttpMethod.PUT, "/api/items/**").hasRole("ADMIN") ;// Only ADMIN can update
			requests.requestMatchers(HttpMethod.DELETE, "/api/items/**").hasRole("ADMIN");
